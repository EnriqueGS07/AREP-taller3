...
//    }
    ...
    public void run() throws IOException {
        ...
        while(running) {
            ...
            else if (request.startsWith("/apps/") && requestType.equals("GET")) {
                outputLine = spark2.getServices().get(request.substring(5));

            }else if (request.startsWith("/apps/") && requestType.equals("POST")) {
                outputLine = spark2.getServices2().get(request.substring(5));
            }
            else{
